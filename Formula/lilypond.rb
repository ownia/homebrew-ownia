class Lilypond < Formula
  ...
  url "https://gitlab.com/lilypond/lilypond/-/archive/v2.25.28/lilypond-v2.25.28.tar.gz"
  sha256 "ded118926a4d995c3d9edd96b4199ee6ccea4fb480bdd90cb5ef98658982c9e4"
  license all_of: [
    "GPL-3.0-or-later",
    "GPL-3.0-only",
    "OFL-1.1-RFN",
